...
class TimePicker extends StatefulWidget {
  ...
  final List<DisabledRange?>? disabledRange;
...
for(var disableInit in _disabledInit!){
  disableInit = pickedTimeToDivision(
      ...
      for(var disableEnd in _disabledEnd! ){
  disableEnd = pickedTimeToDivision(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TimePickerPainter(
        ...
        disabledRangeColor: Colors.red.withOpacity(0.7),
        errorColor: Colors.red.withOpacity(0.7),
  ...
  TimePickerDecoration? getDecoration() {
    if (error == false) {
      return widget.decoration?.copyWith(
        sweepDecoration: widget.decoration?.sweepDecoration
            .copyWith(pickerColor: Colors.red.withOpacity(0.7)),
      );
    }
